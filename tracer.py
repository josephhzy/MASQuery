"""
Source tracing: extract and verify citations from the LLM response.
...
class SourceReference:
    """A verified or unverified source citation from the LLM response."""
...
def extract_citations(response_text: str) -> List[dict]:
    """
    Extract citation patterns from the LLM response text.
